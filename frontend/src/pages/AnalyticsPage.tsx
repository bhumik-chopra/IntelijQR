  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <section className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div><div className="mb-2 flex items-center gap-2"><Badge variant="purple">Milestone 4</Badge><Badge variant="success">Live data</Badge></div><h1 className="text-2xl font-bold text-white sm:text-3xl">Smart QR Analytics</h1><p className="mt-1 text-sm text-slate-500">Understand how your dynamic QR codes perform across visitors and devices.</p></div>
      ...
      {isLoading && !data ? <Card className="flex min-h-80 items-center justify-center"><Spinner size="lg" /></Card> : data && <>
        ...
        <p className="text-xs text-slate-700">Detailed analytics begin with scans recorded after Milestone 4. Raw IP addresses and complete user-agent strings are not stored. Public geolocation requires a local GeoIP database and currently appears as Unknown.</p>
      </>}
    </div>
  );
};
